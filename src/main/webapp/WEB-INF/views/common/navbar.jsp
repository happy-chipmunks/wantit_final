...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-fixed-top">
        <div class="container-fluid">
          ...
          <button type="button" class="btn btn-outline-warning" id="loginBtn">로그인/회원가입</button>
          <span class="myInfo"></span>
          <span class="myAlarm">
            <i class="bi bi-bell" id="alarmIcon"></i>
          </span>
          <button type="button" class="btn" id="askManager">관리자 문의</button>
          <button type="button" class="btn" id="openProject">프로젝트 오픈 신청</button>
