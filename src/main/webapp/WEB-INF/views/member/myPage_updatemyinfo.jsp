...
<body>
    ...
    <h2 class="ttable1" style="color: black; font-weight: bold;">회원수정</h2>
	<form action="${contextPath}/updatemember.me" method="post">
    <div class="tttable">
    	 
    	<div class="input-group mb-3">
            <div class="form-floating">
              <input type="text" class="form-control" id="memberId" name="memberId"  value="${ loginUser.memberId }" required>
        ...
        <br>
        <button type="button" class="btn btn-primary" onclick="location.href='${contextPath}/myPageinfo.me'">
        	<span>
            	<span class="">취소하기</span>
            </span>
        </button>    
       </form>
        <br>
